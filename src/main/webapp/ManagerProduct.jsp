                    ...
                    <tbody>
                        <c:forEach items="${products}" var="o">
                            <tr>
                                ...
                                <td>
                                    <a href="product?action=edit&id=${o.getId()}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="product?action=delete&id=${o.getId()}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
